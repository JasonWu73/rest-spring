...
import net.wuxianjie.core.shared.exception.AbstractBaseException;
...
public class ControllerExceptionHandler {
    ...
    handleHttpRequestMethodNotSupportedException(
        ...
        return new ResponseEntity<>(
                ResponseWrapper.fail("API 不支持当前 HTTP 请求方法"),
    ...
    handleMissingServletRequestParameterException(
        ...
        return new ResponseEntity<>(
                ResponseWrapper.fail(
                        String.format("缺少必填参数【%s】", parameterName)
                ),
                HttpStatus.BAD_REQUEST
        );
    }
    ...
    public ResponseEntity<ResponseDto<Void>> handleAbstractBaseException(
        ...
        return new ResponseEntity<>(
                ResponseWrapper.fail(e.getMessage()),
                e.getHttpStatus()
        );
    }
